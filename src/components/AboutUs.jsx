  ...
  return (
    <div>
      <div className="flex flex-col md:flex">
        ...
        <div className="md:grid grid-cols-2 m-5">
          <div>
            <div className="  md:mt-[50px] mr-4 text-[18px]">
            ...
            <button className="mt-4 mr-[27rem] w-[140px]  rounded-md bg-[#830020] px-4 py-2 text-white ">
              Learn More
            </button>
          </div>
